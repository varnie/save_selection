...
class TestSQLiteDatabase:
    ...
    @patch("repositories.sqlite.scoped_session")
    @patch("repositories.sqlite.sessionmaker")
    def test_in_transaction_returns_session_value(self, mock_sessionmaker, mock_scoped, mock_create_engine):
        """Test that in_transaction returns session.in_transaction()."""
        mock_session = MagicMock()
    ...
    @patch("repositories.sqlite.scoped_session")
    @patch("repositories.sqlite.sessionmaker")
    def test_execute_calls_session_execute(self, mock_sessionmaker, mock_scoped, mock_create_engine):
        """Test that execute calls session.execute with query."""
        mock_session = MagicMock()
    ...
    @patch("repositories.sqlite.scoped_session")
    @patch("repositories.sqlite.sessionmaker")
    def test_flush_calls_session_flush(self, mock_sessionmaker, mock_scoped, mock_create_engine):
        """Test that flush calls session.flush()."""
        mock_session = MagicMock()
        mock_scoped_instance = MagicMock()
        mock_scoped_instance.return_value = mock_session
        mock_scoped.return_value = mock_scoped_instance
